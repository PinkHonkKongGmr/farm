 ...
 const instruction ={
   ru:{
    titleRu:'Инструкция',
    'rules1':<div className = 'discription'>
        Итак, правила!
        <br></br>
        Цель игры - прогресс.
        <br></br>
     ...
     'rules2':<div className = 'discription'>
     ...
     'rules3':<div className = 'discription'>
          Игрок зарабатывает реализовывая игровую продукцию. Это - "милк" и "ики".
         <br></br>
         Производители продукции соответсвено - "мухрю" и "чикены" 
         <br></br>
     ...
     'rules4':<div className = 'discription'>
